      ...
      >
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-white/20">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full px-12 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          ...
          <div className="mt-8 text-center">
            <button
              onClick={() => router.push('/admin-login')}
              className="text-blue-200 hover:text-white transition-colors text-sm flex items-center justify-center"
            >
